...
const int SAlien_Point_NUM = (SAlien_circle * 7); //最大點子總數
...
const int MAlien_Point_NUM = (MAlien_circle * 12); //最大點子總數
...
const int BAlien_Point_NUM = (BAlien_circle * 12) + (BAlien_rectangle * 6 ) ; //最大點子總數
